...
## Corpus Check
- 29 files · ~1,719,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 127 nodes · 147 edges · 14 communities (12 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2858f730`
...
9. `EnquiryProvider()` - 3 edges
10. `React + Vite` - 3 edges

## Surprising Connections (you probably didn't know these)
- `Contact()` --calls--> `useEnquiry()`  [EXTRACTED]
  src/pages/Contact.jsx → src/context/EnquiryContext.jsx
- `Reviews` --calls--> `useEnquiry()`  [EXTRACTED]
  src/pages/Reviews.jsx → src/context/EnquiryContext.jsx
...
- `ContactCTA()` --calls--> `useEnquiry()`  [EXTRACTED]
  src/components/home/ContactCTA.jsx → src/context/EnquiryContext.jsx

## Communities (14 total, 2 thin omitted)

### Community 1 - "Community 1"
Cohesion: 0.14
Nodes (6): Contact(), Facilities, categories, galleryImages, Reviews, pageTransition
...
Cohesion: 0.20
Nodes (10): dependencies, clsx, framer-motion, gsap, lucide-react, react, react-dom, react-helmet-async (+2 more)
...
Cohesion: 0.13
Nodes (7): FloatingEnvelope(), QUOTES, Navbar(), EnquiryContext, EnquiryProvider(), useEnquiry(), ContactCTA()

### Community 11 - "Community 11"
Cohesion: 0.17
Nodes (6): About, Contact, Facilities, Gallery, Home, Reviews
