...
import logoImg from "../../assets/images/sowbhagya-mahal-logo.webp";
...
function FooterHeading({ children }) {
  return (
    <h3 className="font-sans font-medium uppercase tracking-[0.08em] text-[13px] text-[#D4A843]">
      {children}
    </h3>
  );
}
          ...
          <div>
            <Link to="/" className="inline-flex" aria-label="Sowbhagya Mahal home">
              <img
                ...
                width="400"
                height="180"
                className="max-h-[48px] w-auto brightness-[1.26] contrast-[1.08] drop-shadow-[0_12px_28px_rgba(0,0,0,0.28)]"
              />
            </Link>
